...
class Ui_linear_regressor(QMainWindow):
    submitClicked = QtCore.pyqtSignal(list)  # <-- This is the sub window's signal
     
    def setupUi(self, linear_regressor,tdataset):
        self.training_dataset =tdataset       
        linear_regressor.setObjectName("linear_regressor")
        linear_regressor.resize(422, 495)
        icon0 = QtGui.QIcon()
        icon0.addPixmap(QtGui.QPixmap("../feather/activity.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        linear_regressor.setWindowIcon(icon0)
        self.groupBox = QtWidgets.QGroupBox(linear_regressor)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(linear_regressor)
        ...
        self.radioButton_1.setGeometry(QtCore.QRect(20, 70, 151, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(linear_regressor)
        self.buttonBox.setGeometry(QtCore.QRect(230, 450, 181, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.pushButton = QtWidgets.QPushButton(linear_regressor)
        self.pushButton.setGeometry(QtCore.QRect(10, 450, 31, 31))
        self.pushButton.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../feather/help-circle.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton.setIcon(icon4)
        self.pushButton.setObjectName("pushButton")

        
        QtCore.QMetaObject.connectSlotsByName(linear_regressor)
        linear_regressor.setTabOrder(self.comboBox, self.lineEdit_1)
        linear_regressor.setTabOrder(self.lineEdit_1, self.lineEdit_2)
        linear_regressor.setTabOrder(self.lineEdit_2, self.radioButton_1)
        linear_regressor.setTabOrder(self.radioButton_1, self.pushButton)
        linear_regressor.setTabOrder(self.pushButton, self.pushButton_1)
        linear_regressor.setTabOrder(self.pushButton_1, self.pushButton_2)
        linear_regressor.setTabOrder(self.pushButton_2, self.pushButton_3)
        linear_regressor.setTabOrder(self.pushButton_3, self.pushButton_4)
        linear_regressor.setTabOrder(self.pushButton_4, self.listWidget)
        linear_regressor.setTabOrder(self.listWidget, self.listWidget_2)
        self.retranslateUi(linear_regressor)
        
        self.show_variablels()
        self.updateButtonStatus()
        self.setButtonConnections()
        self.buttonBox.accepted.connect(lambda: self.create_model())
        self.buttonBox.rejected.connect(linear_regressor.reject)
        QtCore.QMetaObject.connectSlotsByName(linear_regressor)
        
    def retranslateUi(self, linear_regressor):
        _translate = QtCore.QCoreApplication.translate
        linear_regressor.setWindowTitle(_translate("linear_regressor", "Linear regression"))
        self.groupBox.setTitle(_translate("linear_regressor", "Variables selection"))
        self.label_9.setText(_translate("linear_regressor", "Dependent variable:"))
        self.label_8.setText(_translate("linear_regressor", "Independent variables:"))
        self.label_7.setText(_translate("linear_regressor", "Dataset variables:"))
        self.groupBox_2.setTitle(_translate("linear_regressor", "Hyperparameters"))
        self.label_3.setText(_translate("linear_regressor", "Test size:"))
        self.radioButton_1.setText(_translate("linear_regressor", "Calculate intercept"))
        self.label_2.setText(_translate("linear_regressor", "Random state:"))
        self.lineEdit_2.setPlaceholderText(_translate("linear_regressor", "0"))
    ...
    def create_model(self):
        ...
        coef=[]
        coef= api.get_performLinrearRegressor(self.training_dataset,items,
...
if __name__ == "__main__":
    ...
    linear_regressor = QtWidgets.QDialog()
    ui = Ui_linear_regressor()
    ui.setupUi(linear_regressor)
