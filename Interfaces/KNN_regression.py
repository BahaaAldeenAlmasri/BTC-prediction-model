...
class Ui_Knn_regressor(QMainWindow):
    submitClicked = QtCore.pyqtSignal(list)  # <-- This is the sub window's signal

    def setupUi(self, Knn_regressor,tdataset):
        self.training_dataset =tdataset  
        Knn_regressor.setObjectName("Knn_regressor")
        Knn_regressor.resize(422, 495)
        self.groupBox = QtWidgets.QGroupBox(Knn_regressor)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(Knn_regressor)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(Knn_regressor)
        self.buttonBox.setGeometry(QtCore.QRect(230, 450, 181, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.pushButton = QtWidgets.QPushButton(Knn_regressor)
        ...
        self.retranslateUi(Knn_regressor)
        QtCore.QMetaObject.connectSlotsByName(Knn_regressor)
        Knn_regressor.setTabOrder(self.comboBox, self.lineEdit_1)
        Knn_regressor.setTabOrder(self.lineEdit_1, self.lineEdit_2)
        Knn_regressor.setTabOrder(self.lineEdit_2, self.lineEdit_3)
        Knn_regressor.setTabOrder(self.lineEdit_3, self.pushButton)
        Knn_regressor.setTabOrder(self.pushButton, self.pushButton_1)
        Knn_regressor.setTabOrder(self.pushButton_1, self.pushButton_2)
        Knn_regressor.setTabOrder(self.pushButton_2, self.pushButton_3)
        Knn_regressor.setTabOrder(self.pushButton_3, self.pushButton_4)
        Knn_regressor.setTabOrder(self.pushButton_4, self.listWidget)
        Knn_regressor.setTabOrder(self.listWidget, self.listWidget_2)
        
        self.show_variablels()
        self.updateButtonStatus()
        self.setButtonConnections()
        self.buttonBox.accepted.connect(lambda: self.create_model())
        self.buttonBox.rejected.connect(Knn_regressor.reject)
        
    def retranslateUi(self, Knn_regressor):
        _translate = QtCore.QCoreApplication.translate
        Knn_regressor.setWindowTitle(_translate("Knn_regressor", "KNN regression"))
        self.groupBox.setTitle(_translate("Knn_regressor", "Variables selection"))
        self.label_9.setText(_translate("Knn_regressor", "Dependent variable:"))
        self.label_8.setText(_translate("Knn_regressor", "Independent variables:"))
        self.label_7.setText(_translate("Knn_regressor", "Dataset variables:"))
        self.groupBox_2.setTitle(_translate("Knn_regressor", "Hyperparameters"))
        self.label_3.setText(_translate("Knn_regressor", "Test size:"))
        self.label_2.setText(_translate("Knn_regressor", "Random state:"))
        self.label_4.setText(_translate("Knn_regressor", "N-neighbors:"))
        self.lineEdit_2.setPlaceholderText(_translate("Knn_regressor", "0"))
    ...
    def create_model(self):
        ...
        coef=[]
        coef= api.get_performKnnRegressor(self.training_dataset,items,
...
if __name__ == "__main__":
    ...
    Knn_regressor = QtWidgets.QWidget()
    ui = Ui_Knn_regressor()
    ui.setupUi(Knn_regressor,[])
    Knn_regressor.show()
    sys.exit(app.exec_())
